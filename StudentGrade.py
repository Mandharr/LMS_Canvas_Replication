...
class MainClass:
    ...
    def SeeassingmentGrades(self):
        ...
        if mycursor.rowcount == 0:
            tkinter.messagebox.showinfo("Error", message="No records where found. Use Post Assignment Grades if you want to updates records")
...
graderoot.title("Admin GradeBook")
mainloop()
