...
class MainClass:
    ...
    def adminannoun(self):
        ...
        header_file_frame = LabelFrame(Adminannoun, text="Welcome to the University of Bridgeport") \
        ...
        mainframe = LabelFrame(Adminannoun, text="Course Announcements").pack(fill="both", expand="yes")
...
Adminannoun = Tk()
app = MainClass(Adminannoun)
screen_width = Adminannoun.winfo_screenwidth()
screen_height = Adminannoun.winfo_screenheight()
screen_resolution = str(screen_width) + 'x' + str(screen_height)
Adminannoun.geometry(screen_resolution)
Adminannoun.title("Admin Announcement")
mainloop()
